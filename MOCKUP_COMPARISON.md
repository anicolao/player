...
codes. The browser uploader is bundled in the internal `Player/ReceiverWeb` path; its pairing,
...
| --- | --- | --- | --- |
| Fixed custom tab and card chrome | Native iOS navigation, controls, sheets, and Liquid Glass tab presentation carry the warm Bookshelf palette. | System interaction behavior, accessibility, and future OS compatibility take precedence over reproducing decorative chrome. Exact committed baselines still have zero spatial tolerance. | Stories 001–011 |
