...
ledger contains **167 unique signatures** and **24 formal qualification
resets**.
...
The ledger now contains 167 unique signatures and retains 24 formal resets.
The replacement tip must pass the normal gate before its one permitted formal
dispatch.
